                ...
                <div style="max-height: 300px; overflow-y: auto;">
                    ...
                    <li>
                        <a class="dropdown-item py-3 border-bottom d-flex align-items-start gap-3 <?php echo e($notification->read_at ? 'opacity-75' : 'bg-light-blue'); ?>" href="#">
                            <div class="icon-circle <?php echo e(($notification->data['status'] ?? 'confirmed') == 'cancelled' ? 'bg-danger' : 'bg-success'); ?> text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; flex-shrink: 0;">
                                <i class="bi <?php echo e(($notification->data['status'] ?? 'confirmed') == 'cancelled' ? 'bi-x-circle' : 'bi-check2-circle'); ?>"></i>
                            </div>
                            <div>
                                <p class="small mb-1 text-wrap" style="line-height: 1.4;"><?php echo e($notification->data['message']); ?></p>
    ...
    <div class="mb-4">
        <h3 class="fw-bold h4 mb-1">
            ...
            $salutation = ($heure < 18) ? 'Bonjour' : 'Bonsoir' ;
                ?>
                <?php echo e($salutation); ?>, <?php echo e(explode(' ', Auth::user()->name)[0]); ?> 👋
                </h3>
    ...
    <div class="alert alert-appointment border-0 shadow-sm mb-4">
        <div class="d-flex align-items-center">
            ...
            <div class="text-white">
                <h5 class="mb-1 fw-bold">Prochain rendez-vous le <?php echo e(\Carbon\Carbon::parse($prochainRDV->date)->format('d/m/Y')); ?> à <?php echo e($prochainRDV->time); ?></h5>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-primary text-white position-relative overflow-hidden card-advice">
                ...
                <div class="card-body p-4 p-lg-5 position-relative">
                    ...
                    <p class="fs-4 fw-medium lh-base mb-5" style="max-width: 90%;">"<?php echo e($consigneAleatoire); ?>"</p>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <small class="text-muted">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($derniereConsultation): ?>
                            Dernière mise à jour le <?php echo e($derniereConsultation->created_at->format('d/m/Y')); ?>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="p-3 border rounded-4 bg-light bg-opacity-50">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="fw-bold text-dark"><?php echo e($derniereConsultation->tension ?? '--'); ?></span>
                            </div>
                        ...
                        <div class="p-3 border rounded-4 bg-light bg-opacity-50">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="fw-bold text-dark">
                                    <?php echo e($derniereConsultation->temperature ?? '--'); ?>
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-danger"
                                    role="progressbar"
                                    style="width: <?php echo e($derniereConsultation->temperature ?? 0); ?>%;"
                                    aria-valuenow="<?php echo e($derniereConsultation->temperature ?? 0); ?>"
                                    aria-valuemin="0"
                                    aria-valuemax="100">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="p-3 border rounded-4 bg-light bg-opacity-50">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="fw-bold text-dark">
                                    <?php echo e($derniereConsultation->fc_bpm ?? '--'); ?>
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-info"
                                    role="progressbar"
                                    style="width: <?php echo e($derniereConsultation->fc_bpm ?? 0); ?>%;"
                                    aria-valuenow="<?php echo e($derniereConsultation->fc_bpm ?? 0); ?>"
                                    aria-valuemin="0"
                                    aria-valuemax="150">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="p-3 border rounded-4 bg-light bg-opacity-50">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="fw-bold text-dark">
                                    <?php echo e($derniereConsultation->poids ?? '--'); ?>
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-warning"
                                    role="progressbar"
                                    style="width: <?php echo e($derniereConsultation->poids ?? 0); ?>%;"
                                    aria-valuenow="<?php echo e($derniereConsultation->poids ?? 0); ?>"
                                    aria-valuemin="0"
                                    aria-valuemax="150">
                                </div>
                            </div>
