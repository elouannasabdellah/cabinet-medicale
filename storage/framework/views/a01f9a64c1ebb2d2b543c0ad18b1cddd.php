                ...
                <div class="card-body p-0">
                    <div class="d-flex flex-column flex-md-row h-100">
                        ...
                        <div class="bg-primary text-white p-4 d-flex flex-column justify-content-between rounded-start-4" style="min-width: 180px;">
                            <div>
                                <span class="badge bg-warning text-dark fw-bold mb-3">N° <?php echo e($id); ?></span>
                                <h4 class="fw-bold mb-1"><?php echo e($premiere->created_at->format('d')); ?></h4>
                                <p class="text-uppercase small mb-0"><?php echo e($premiere->created_at->format('M Y')); ?></p>
                            </div>
                        ...
                        <div class="flex-grow-1 p-4 bg-white rounded-end-4">
                            ...
                            <div class="prescription-box mb-4">
                                ...
                                <div class="d-flex align-items-start mb-3 border-start border-warning border-3 ps-3">
                                    <div>
                                        <h6 class="mb-0 fw-bold"><?php echo e($item->medicament_nom); ?></h6>
                                        <small class="text-muted"><?php echo e($item->posologie); ?> • <?php echo e($item->duree); ?></small>
                                    </div>
                                </div>
            ...
            <div class="card border-0 shadow-lg overflow-hidden custom-card">
                <div class="row g-0">
                    ...
                    <div class="col-md-1 bg-primary d-flex flex-md-column justify-content-center align-items-center p-3 text-white gap-3">
                        ...
                        <div class="rotated-text fw-bold text-warning"><?php echo e($premiere->created_at->format('M Y')); ?></div>
                    </div>

                    <div class="col-md-8 bg-white p-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <span class="badge rounded-pill bg-primary text-warning px-3 py-2">RÉF #ORD-00<?php echo e($id); ?></span>
                            <span class="text-muted small"><i class="bi bi-clock-history me-1"></i> Émis le <?php echo e($premiere->created_at->format('d/m/Y')); ?></span>
                        </div>
                            ...
                            <div class="col">
                                <div class="p-3 border rounded-3 bg-light-blue h-100">
                                    <div class="d-flex align-items-center gap-2 mb-1">
                                        ...
                                        <strong class="text-primary"><?php echo e($item->medicament_nom); ?></strong>
                                    </div>
                                    <div class="ps-3 small text-muted"><?php echo e($item->posologie); ?> • <?php echo e($item->duree); ?></div>
                                </div>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    ...
                    <div class="col-md-3 bg-light d-flex flex-column justify-content-center p-4 border-start border-warning border-3">
                        <div class="text-center mb-4 d-none d-md-block">
                            <img src="<?php echo e(asset('img/qr-placeholder.png')); ?>" class="img-fluid rounded border border-2 border-warning" style="max-width: 100px;" alt="QR Code">
                        </div>
                        <a href="<?php echo e(route('patient.ordonnance.download', $id)); ?>" 
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-lg rounded-4 h-100 overflow-hidden">
                <div class="bg-primary p-4 d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="text-white fw-bold mb-0">Ordonnance #ORD-00<?php echo e($id); ?></h5>
                        <small class="text-warning fw-semibold">Consultation du <?php echo e($premiere->created_at->format('d/m/Y')); ?></small>
                    </div>
                ...
                <div class="card-body p-4 bg-white">
                    ...
                    <div class="prescription-list bg-light p-3 rounded-4 border-start border-warning border-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2 last-no-border pb-2 border-bottom border-white">
                            <div>
                                <span class="d-block fw-bold text-dark"><?php echo e($item->medicament_nom); ?></span>
                                <small class="text-muted"><?php echo e($item->posologie); ?></small>
                            </div>
                            <span class="badge bg-primary text-warning rounded-pill"><?php echo e($item->duree); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden h-100">
                <div class="bg-primary px-3 py-2 d-flex justify-content-between align-items-center">
                    <span class="text-white small fw-bold">#ORD-00<?php echo e($id); ?></span>
                ...
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between mb-3">
                        <div class="small text-muted">
                            <i class="bi bi-calendar3"></i> <?php echo e($premiere->created_at->format('d/m/Y')); ?>
                    ...
                    <div class="bg-light p-2 rounded-2 mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-1 border-bottom border-white pb-1 last-no-border">
                            <span class="small fw-bold text-dark text-truncate" style="max-width: 120px;">
                                <?php echo e($item->medicament_nom); ?>

                            </span>
                            <span class="badge bg-primary-light text-primary x-small"><?php echo e($item->duree); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LARAVEL\TODO\todo-list\resources\views/patient/ordonnance.blade.php ENDPATH**/ ?>