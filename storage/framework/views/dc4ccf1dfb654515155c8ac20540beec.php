            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route(auth()->user()->role . '.dashboard')); ?>" class="btn btn-primary rounded-pill px-4 ms-3">Tableau de Bord</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="nav-link mx-2">Connexion</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-warning text-white rounded-pill px-4 shadow-sm fw-bold">S'inscrire</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex gap-3">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg rounded-pill px-5 shadow">Prendre RDV</a>
    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 offset-lg-1" data-aos="fade-left">
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary rounded-pill px-4 py-2 mt-3">Créer mon dossier maintenant</a>
            </div>
        </div>
    </div>
</section>
...
</html><?php /**PATH D:\LARAVEL\TODO\todo-list\resources\views/welcome.blade.php ENDPATH**/ ?>