...
<div class="container-fluid py-4" style="background-color: #f7f9fc; min-height: 600px; font-family: 'Poppins', sans-serif;">
    ...
    <div class="card border-0 shadow-sm rounded-3 mx-auto main-consultation-card" style="max-width: 1000px; background-color: #fff;">
        ...
        <div class="p-4 border-bottom" style="border-color: #eaedf3;">
            <div class="d-flex flex-column flex-sm-row align-items-center align-items-sm-start mb-3 text-center text-sm-start">
                <div class="avatar-circle-indigo mb-3 mb-sm-0 me-sm-3 shadow-inner">
                    <span class="fw-bold"><?php echo e(strtoupper(substr($rdv->patient_name, 0, 2))); ?></span>
                </div>
                <div class="flex-grow-1">
                    <h5 class="fw-bold m-0 text-dark"><?php echo e($rdv->patient_name); ?></h5>
                    <div class="d-flex flex-wrap justify-content-center justify-content-sm-start align-items-center text-muted small mt-1 gap-2 gap-sm-3">
                        ...
                        <span><i class="bi bi-person me-1"></i><?php echo e($rdv->patient->age ?? 'N/A'); ?> ans</span>
                        <span class="text-danger fw-bold"><i class="bi bi-droplet-fill me-1"></i><?php echo e($rdv->patient->groupe_sanguin ?? '?'); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rdv->patient->allergies): ?>
                            <span class="text-warning-dark fw-bold"><i class="bi bi-exclamation-triangle-fill me-1"></i>Allergie : <?php echo e($rdv->patient->allergies); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="d-flex flex-wrap justify-content-center justify-content-sm-start gap-2">
                <span class="badge-status-green">RDV #<?php echo e($rdv->id); ?> • <?php echo e(now()->format('H:i')); ?> </span>
            </div>
        </div>
        ...
        <div class="p-3 p-sm-4 bg-white">
            ...
            <form action="<?php echo e(route('doctor.consultation.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                
                
                <input type="hidden" name="patient_id" value="<?php echo e($rdv->patient_id); ?>">
                <input type="hidden" name="doctor_id" value="<?php echo e($rdv->doctor_id); ?>">
                <input type="hidden" name="rdv_id" value="<?php echo e($rdv->id); ?>">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-end align-items-center mt-3 pt-3 border-top gap-3" style="border-color: #eaedf3;">
                    <a href="<?php echo e(url()->previous()); ?>" class="btn-secondary-epure w-100 w-sm-auto order-2 order-sm-1 text-center text-decoration-none">Annuler</a>
...
<?php echo $__env->make('layouts.patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LARAVEL\TODO\todo-list\resources\views/doctor/consultation.blade.php ENDPATH**/ ?>