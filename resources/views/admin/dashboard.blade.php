        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0">{{ $stats['rdv_aujourdhui'] }}</h3>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0"> {{ $stats['consultations'] }}</h3>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm p-4 h-100">
                ...
                <div class="mt-4">
                    ...
                    @foreach($specialtyLabels as $index => $label)
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex align-items-center">
                            <div class="rounded-circle me-2"
                                style="width: 12px; height: 12px; background-color: {{ $colors[$index % count($colors)] }};">
                            </div>
                            <span class="text-muted small">{{ $label }}</span>
                        </div>
                        <span class="fw-bold small">{{ $specialtyData[$index] }}</span>
                    </div>
                    @endforeach
                </div>
            </div>
