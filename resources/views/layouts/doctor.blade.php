    ...
    <div class="sidebar d-flex flex-column p-4 text-white" 
        ...
        <ul class="nav nav-pills flex-column mb-4" style="gap: 8px; list-style: none; padding: 0;">
            <li class="nav-item">
                ...
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('doctor.dashboard') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('doctor.rdv') }}" 
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('doctor.rdv') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
            ...
            <li class="nav-item">
                ...
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('doctor.calendarIndex') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
        ...
        <ul class="nav nav-pills flex-column mb-4" style="gap: 8px; list-style: none; padding: 0;">
            <li class="nav-item">
                <a href="#"  class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->is('doctor/consultation*') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
            ...
            <li class="nav-item">
                ...
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('doctor.availability.index') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
                    <i class="bi bi-clock-history fs-5"></i> 
                    <span>Mes Disponibilités</span>
                </a>
            </li>
              <li class="nav-item">
                <a href="{{ route('doctor.historique') }}" 
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('doctor.historique') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
                    <i class="bi bi-clock-history fs-5"></i> 
        ...
        {{-- <ul class="nav nav-pills flex-column mt-auto border-top pt-4 border-secondary border-opacity-25" style="list-style: none; padding: 0;">
            <li class="nav-item">
        ...
        <ul class="nav nav-pills flex-column mt-auto border-top pt-4 border-secondary border-opacity-25" style="list-style: none; padding: 0; gap: 8px;">
            <li class="nav-item">
                ...
                class="nav-link text-white d-flex align-items-center gap-3 py-2.5 px-3 rounded-3 {{ request()->routeIs('profile.*') ? 'bg-primary' : 'opacity-75 hover-opacity' }}">
            ...
            <li class="nav-item">
                <form method="POST" action="{{ route('logout') }}" id="logout-form">
                    ...
                    style="color: #ffb3b3 !important;"> {{-- Un rouge très léger pour la déconnexion --}}
